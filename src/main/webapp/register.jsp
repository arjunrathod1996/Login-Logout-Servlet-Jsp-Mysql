...
<body style = "background-image: linear-gradient(to right top, #3b7c60, #529c66, #78bb64, #aad95b, #e6f450); background-repeat:no-repeat; background-attachment: fixed;background-size: cover;">
						...
						<form action = "registerServlet" method = "post">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Enter Full Name</label> <input
									...
									aria-describedby="emailHelp" placeholder="Enter Full Name" name = "uname">
							</div>
